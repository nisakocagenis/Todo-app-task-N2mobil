Bu proje, kullanıcıların kayıt olup giriş yapabileceği, yapılacaklar listesi oluşturabileceği, post ekleyip görüntüleyebileceği ve albüm yönetimi yapabileceği bir web uygulamasıdır.
